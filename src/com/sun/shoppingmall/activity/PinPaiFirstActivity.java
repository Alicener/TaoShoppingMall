...
public class PinPaiFirstActivity extends Activity implements OnRefreshListener{
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		setContentView(R.layout.pinpaifirst_activity);
			...
			case 11:
				...
				try {
					...
					if(array==null){
						...
						if(adapter==null){
							adapter=new PreachAdapter(PinPaiFirstActivity.this, list);
						...
						listview.setOnItemClickListener(new OnItemClickListener() {
							...
							public void onItemClick(AdapterView<?> parent,
								...
								// TODO Auto-generated method stub
								Intent intent=new Intent(PinPaiFirstActivity.this,ActivityProductActivity.class);

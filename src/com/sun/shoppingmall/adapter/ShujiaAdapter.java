...
public class ShujiaAdapter extends BaseAdapter{
	...
	private List<ShujiaEntity>lists=new ArrayList<ShujiaEntity>();
	public ShujiaAdapter(Context context,List<ShujiaEntity>lists) {
	...
	public View getView(int position, View convertView, ViewGroup parent) {
		...
		if(convertView==null){
			...
			convertView=View.inflate(context, R.layout.shujia_adapter, null);

...
public class TaoAdapter extends BaseAdapter{
	...
	private List<TaoEntity>lists=new ArrayList<TaoEntity>();
	public TaoAdapter(Context context,List<TaoEntity>lists) {
	...
	public View getView(int position, View convertView, ViewGroup parent) {
		...
		if(convertView==null){
			...
			convertView=View.inflate(context, R.layout.tao_adapter, null);

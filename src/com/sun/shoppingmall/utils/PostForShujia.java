...
import com.sun.shoppingmall.adapter.ShujiaAdapter;
import com.sun.shoppingmall.customview.CustomGridView;
import com.sun.shoppingmall.entity.ShujiaEntity;

public class PostForShujia {
	...
	private List<ShujiaEntity>list=new ArrayList<ShujiaEntity>();
	public PostForShujia(Context context,  String shop_num,CustomGridView listview) {
		super();
...
//	}
	...
	public void addListData(){
		...
		list.add(new ShujiaEntity());
		list.add(new ShujiaEntity());
		list.add(new ShujiaEntity());
		listview.setAdapter(new ShujiaAdapter(context, list));
		listview.setOnItemClickListener(new OnItemClickListener() {
			...
			public void onItemClick(AdapterView<?> parent, View view,
				...
				Intent intent=new Intent(context,ActivityProductActivity.class);

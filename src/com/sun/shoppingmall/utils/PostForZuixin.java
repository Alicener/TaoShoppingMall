...
import com.sun.shoppingmall.activity.ShopActivity;
import com.sun.shoppingmall.adapter.ZuixinAdapter;
import com.sun.shoppingmall.customview.MyListView;
import com.sun.shoppingmall.entity.ZuixinEntity;

public class PostForZuixin {
	...
	private List<ZuixinEntity>list=new ArrayList<ZuixinEntity>();
	public PostForZuixin(Context context,  String shop_num,MyListView listview) {
		super();
...
//	}
	...
	public void addListData(){
		...
		list.add(new ZuixinEntity());
		list.add(new ZuixinEntity());
		list.add(new ZuixinEntity());
		list.add(new ZuixinEntity());
		listview.setAdapter(new ZuixinAdapter(context, list));

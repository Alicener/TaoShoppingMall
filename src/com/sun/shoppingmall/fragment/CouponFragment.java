...
public class CouponFragment extends Fragment implements OnClickListener{
	...
	public View onCreateView(LayoutInflater inflater, ViewGroup container,
		...
		user_id = "2";
		post = new PostForTicketlist(getActivity(), "10", listView, mhandler, "coupon", "order_list", user_id, "1", "");
		post.addListData();
		initview();
		return view;
	}
	...
	public void onClick(View v) {
		...
		case R.id.cantuse:
			...
			used.setTextColor(Color.BLACK);
			post = new PostForTicketlist(getActivity(), "10", listView, mhandler, "coupon", "order_list", user_id, "2", "");
			post.addListData();
			break;
		case R.id.used:
			...
			notuse.setTextColor(Color.BLACK);
			cantuse.setTextColor(Color.BLACK);
			post = new PostForTicketlist(getActivity(), "10", listView, mhandler, "coupon", "order_list", user_id, "3", "");
			post.addListData();
			break;
			...
			case 11:
				try {
					...
					for (int i = 0; i < array.length(); i++) {
						...
						entity.setMoney(jsonObject.optString("money"));
						list.add(entity);
					}
					if (adapter==null) {
